...
class SudokuBoardView(context: Context, attributeSet: AttributeSet) : View(context, attributeSet) {
    ...
    private var cells: List<CellInt>? = null

    private val thickLinePaint = Paint().apply {
        style = Paint.Style.STROKE
        context.theme.resolveAttribute(R.attr.fondoBotones, typedValue, true)
        color = typedValue.data // This is the resolved color integer
        strokeWidth = 4F
    }
    ...
    private val selectedCellPaint = Paint().apply {
        ...
        color = "#00e018".toColorInt()
    }

    private val conflictingCellPaint = Paint().apply {
        style = Paint.Style.FILL_AND_STROKE
        color = "#8b8b8b".toColorInt()
    }

    private val textPaint = Paint().apply {
        style = Paint.Style.FILL_AND_STROKE
        context.theme.resolveAttribute(R.attr.textos, typedValue, true)
        color = typedValue.data // This is the resolved color integer
    }
    ...
    fun updateCells(cells: List<CellInt>) {
        this.cells = cells
        invalidate()
    }
